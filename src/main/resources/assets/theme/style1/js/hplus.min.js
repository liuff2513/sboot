...
//alert(111);
//if($("#home-left").hasClass("sidebar-collapse")){
//    $("#home-left").removeClass('sidebar-collapse');
//}
...
}), $(document).ready(function ()
{
    ...
    }), $(".check-link").click(function ()
    {
        ...
        return a.toggleClass("fa-check-square").toggleClass("fa-square-o"), e.toggleClass("todo-completed"), 
        !1
    }), $(function ()
    {
    ...
    {
        $(window).width() < 895 && NavToggle()
    }), $(".nav-close").click(NavToggle)
}), $(window).bind("load resize", function ()
{/*xie 17/1/17 769改为895*/
    $(this).width() < 895 && ($("body").addClass("mini-navbar"), $(".navbar-static-side").fadeIn())
}), $(function ()
{
    ...
    {
        var a = localStorage.getItem("collapse_menu"), e = localStorage.getItem("fixednavbar"), i = localStorage.getItem("boxedlayout"), 
        l = $("body");
        "on" == a && (l.hasClass("body-small") || l.addClass("mini-navbar")), "on" == e && ($(".navbar-static-top").removeClass("navbar-static-top").addClass("navbar-fixed-top"), 
        l.addClass("fixed-nav")), "on" == i && l.addClass("boxed-layout")
    }
});
