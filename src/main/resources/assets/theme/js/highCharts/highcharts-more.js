    ...
    "object" === typeof module && module.exports ? module.exports = x: x(Highcharts)
        ...
        w(r.prototype, {
            init: function(b, a, d) {
                ...
                h = f.defaultOptions;
                f.chart = a;
                f.options = b = m(h, a.angular ? {
                    background: {}
                }: void 0, b); (b = b.background) && t([].concat(q(b)).reverse(),
                function(a) {
                    var c, h = d.userOptions;
        ...
        l = {
            ...
            getLinePath: function(a, g) {
                ...
                this.isCircular || void 0 !== g ? g = this.chart.renderer.symbols.arc(this.left + a[0], this.top + a[1], f, f, {
                    start: this.startAngleRad,
                    end: this.endAngleRad,
                    open: !0,
                    innerR: 0
                }) : (g = this.postTranslate(this.angleRad, f), g = ["M", a[0] + c.plotLeft, a[1] + c.plotTop, "L", g.x, g.y]);
                return g
            },
            ...
            setAxisSize: function() {
                ...
                this.isRadial && (this.center = this.pane.center = r.getCenter.call(this.pane), this.isCircular && (this.sector = this.endAngleRad - this.startAngleRad), this.len = this.width = this.height = this.center[2] * d(this.sector, 1) / 2)
            },
            getPosition: function(a, g) {
                return this.postTranslate(this.isCircular ? this.translate(a) : this.angleRad, d(this.isCircular ? g: this.translate(a), this.center[2] / 2) - this.offset)
            },
            ...
            getPlotBandPath: function(a, g, c) {
                ...
                u,
                e = this.isCircular;
                "polygon" === this.options.gridLineInterpolation ? h = this.getPlotLinePath(a).concat(this.getPlotLinePath(g, !0)) : (a = Math.max(a, this.min), g = Math.min(g, this.max), e || (n[0] = this.translate(a), n[1] = this.translate(g)), n = m(n,
                function(a) {
                    l.test(a) && (a = f(a, 10) * k / 100);
                    return a
                }), "circle" !== c.shape && e ? (a = p + this.translate(a), g = p + this.translate(g)) : (a = -Math.PI / 2, g = 1.5 * Math.PI, u = !0), n[0] -= b, n[2] -= b, h = this.chart.renderer.symbols.arc(this.left + h[0], this.top + h[1], n[0], n[0], {
                    start: Math.min(a, g),
                    end: Math.max(a, g),
            ...
            getPlotLinePath: function(a, g) {
                ...
                b,
                p;
                d.isCircular ? p = ["M", c[0] + f.plotLeft, c[1] + f.plotTop, "L", h.x, h.y] : "circle" === d.options.gridLineInterpolation ? (a = d.translate(a)) && (p = d.getLinePath(0, a)) : (t(f.xAxis,
                function(a) {
                    a.pane === d.pane && (k = a)
                }), p = [], a = d.translate(a), c = k.tickPositions, k.autoConnect && (c = c.concat([c[0]])), g && (c = [].concat(c).reverse()), t(c,
                function(g, d) {
                    b = k.getPosition(g, a);
        ...
        function(f, g, k) {
            ...
            m = k.pane || 0;
            if (b) {
                if (w(this, u ? c: l), e = !n) this.defaultRadialOptions = this.defaultRadialGaugeOptions
            ...
            b || p ? (this.isRadial = !0, g.inverted = !1, A.chart.zoomType = null) : this.isRadial = !1;
            f.call(this, g, k);
            u || !b && !p || (f = this.options, g.panes || (g.panes = []), this.pane = g = g.panes[m] = g.panes[m] || new a(h(A.pane)[m], g, this), g = g.options, this.angleRad = (f.angle || 0) * Math.PI / 180, this.startAngleRad = (g.startAngle - 90) * Math.PI / 180, this.endAngleRad = (d(g.endAngle, g.startAngle + 360) - 90) * Math.PI / 180, this.offset = f.offset || 0, this.isCircular = e)
        });
        u(k, "autoLabelAlign",
        function(a) {
        ...
        u(b, "getLabelPosition",
        function(a, g, c, f, h, k, b, l, u) {
            var n = this.axis,
            p = k.y,
            e = 20,
            y = k.align,
            v = (n.translate(this.pos) + n.startAngleRad + Math.PI / 2) / Math.PI * 180 % 360;
            n.isRadial ? (a = n.getPosition(this.pos, n.center[2] / 2 + d(k.distance, -25)), "auto" === k.rotation ? f.attr({
                rotation: v
            }) : null === p && (p = n.chart.renderer.fontMetrics(f.styles.fontSize).b - f.getBBox().height / 2), null === y && (n.isCircular ? (this.label.getBBox().width > n.len * n.tickInterval / (n.max - n.min) && (e = 0), y = v > e && v < 180 - e ? "left": v > 180 + e && v < 360 - e ? "right": "center") : y = "center", f.attr({
                align: y
            })), a.x += k.x, a.y += p) : a = a.call(this, g, c, f, h, k, b, l, u);
            return a
        });
        u(b, "getMarkPath",
        function(a, d, c, f, h, k, b) {
            var g = this.axis;
            g.isRadial ? (a = g.getPosition(this.pos, g.center[2] / 2 + f), d = ["M", d, c, "L", a.x, a.y]) : d = a.call(this, d, c, f, h, k, b);
            return d
        })
    })(x); (function(b) {
        var r = b.each,
        ...
        },
        {
            ...
            highToXY: function(a) {
                var d = this.chart,
                f = this.xAxis.postTranslate(a.rectPlotX, this.yAxis.len - a.plotHigh);
            ...
            translate: function() {
                ...
                function(h) {
                    ...
                    c = h.high,
                    l = h.plotY;
                    null === c || null === b ? h.isNull = !0 : (h.plotLow = l, h.plotHigh = d.translate(f ? a.modifyValue(c, h) : c, 0, 1, 0, 1), f && (h.yBottom = h.plotHigh))
                });
                this.chart.polar && r(this.points,
                function(d) {
                    a.highToXY(d)
                })
            },
            getGraphPath: function(a) {
                ...
                var p = k.step;
                a = a || this.points;
                for (h = a.length; h--;) c = a[h],
                c.isNull || k.connectEnds || a[h + 1] && !a[h + 1].isNull || f.push({
                    plotX: c.plotX,
                    plotY: c.plotY,
                    doCurve: !1
                }),
            ...
            drawDataLabels: function() {
                ...
                if (c.enabled || this._hasPointLabels) {
                    for (f = d; f--;) if (g = a[f]) n = p ? g.plotHigh < g.plotLow: g.plotHigh > g.plotLow,
                    g.y = g.high,
                    g._plotY = g.plotY,
                    g.plotY = g.plotHigh,
                    h[f] = g.dataLabel,
                    ...
                    g.below = n,
                    e ? l || (c.align = n ? "right": "left") : k || (c.verticalAlign = n ? "top": "bottom"),
                    c.x = c.xHigh,
                    c.y = c.yHigh;
                    ...
                    g.plotY = g._plotY,
                    g.below = !n,
                    e ? l || (c.align = n ? "left": "right") : k || (c.verticalAlign = n ? "bottom": "top"),
                    c.x = c.xLow,
                    c.y = c.yLow;
                    b.drawDataLabels && b.drawDataLabels.apply(this, arguments)
                }
        ...
        e("columnrange", "arearange", w(r.column, r.arearange, {
            lineWidth: 1,
            pointRange: null
        }), {
            translate: function() {
                ...
                function(a) {
                    ...
                    Math.abs(e) < h ? (h -= e, e += h, v -= h / 2) : 0 > e && (e *= -1, v -= e);
                    k ? (c = a.barX + u, a.shapeType = "path", a.shapeArgs = {
                        d: d.polarArc(v + e, v, c, c + a.pointWidth)
                    }) : (g.height = e, g.y = v, a.tooltipPos = l.inverted ? [f.len + f.pos - l.plotLeft - v - e / 2, b.len + b.pos - l.plotTop - g.x - g.width / 2, e] : [b.left - l.plotLeft + g.x + g.width / 2, f.pos - l.plotTop + v + e / 2, e])
                })
            },
            directTouch: !0,
        ...
        },
        {
            ...
            translate: function() {
                ...
                function(c) {
                    ...
                    t(e) ? (e = e / 180 * Math.PI, v = Math.max(a.startAngleRad - e, Math.min(a.endAngleRad + e, v))) : !1 === d.wrap && (v = Math.max(a.startAngleRad, Math.min(a.endAngleRad, v)));
                    v = 180 * v / Math.PI;
                    c.shapeType = "path";
                    c.shapeArgs = {
                        d: f.path || ["M", -g, -n / 2, "L", h, -n / 2, k, -u / 2, k, u / 2, h, n / 2, -g, n / 2, "z"],
                        translateX: b[0],
                        translateY: b[1],
                        rotation: v
                    };
            ...
            drawPoints: function() {
                ...
                function(d) {
                    ...
                    f = b.d,
                    h = w(c.dial, d.dial);
                    g ? (g.animate(b), b.d = f) : (d.graphic = k[d.shapeType](b).attr({
                        rotation: b.rotation,
                        zIndex: 1
                    }).addClass("highcharts-dial").add(a.group), d.graphic.attr({
                ...
                b ? b.animate({
                    translateX: d[0],
                    translateY: d[1]
                }) : (a.pivot = k.circle(0, 0, m(l.radius, 5)).attr({
                    zIndex: 2
        ...
        },
        {
            ...
            drawPoints: function() {
                ...
                d = b.chart.renderer,
                f, h, u, c, l, k, p = 0,
                g, n, m, q, v = !1 !== b.doQuartiles,
                t, x = b.options.whiskerLength;
                r(b.points,
                function(e) {
                    var r = e.graphic,
                    y = r ? "animate": "attr",
        ...
        },
        {
            ...
            translate: function() {
                var d = this.options,
                b = this.yAxis,
                h, e, c, l, k, p, g, n, m, q = w(d.minPointLength, 5),
                v = d.threshold,
                t = d.stacking;
                ...
                e = this.points;
                h = 0;
                for (d = e.length; h < d; h++) c = e[h],
                p = this.processedYData[h],
                l = c.shapeArgs,
                m = (k = t && b.stacks[(this.negStacks && p < v ? "-": "") + this.stackKey]) ? k[c.x].points[this.index + "," + h] : [0, p],
                c.isSum ? c.y = r(p) : c.isIntermediateSum && (c.y = r(p - n)),
                k = Math.max(g, g + c.y) + m[0],
                l.y = b.toPixels(k, !0),
                c.isSum ? (l.y = b.toPixels(m[1], !0), l.height = Math.min(b.toPixels(m[0], !0), b.len) - l.y + this.minPointLengthOffset) : c.isIntermediateSum ? (l.y = b.toPixels(m[1], !0), l.height = Math.min(b.toPixels(n, !0), b.len) - l.y + this.minPointLengthOffset, n = m[1]) : (l.height = 0 < p ? b.toPixels(g, !0) - l.y: b.toPixels(g, !0) - b.toPixels(g - p, !0), g += p),
                0 > l.height && (l.y += l.height, l.height *= -1),
                c.plotY = l.y = Math.round(l.y) - this.borderWidth % 2 / 2,
                l.height = Math.max(Math.round(l.height), .001),
                c.yBottom = l.y + l.height,
                l.height <= q && (l.height = q, this.minPointLengthOffset += q),
                l.y -= this.minPointLengthOffset,
                l = c.plotY + (c.negative ? l.height: 0) - this.minPointLengthOffset,
                this.chart.inverted ? c.tooltipPos[0] = b.len - l: c.tooltipPos[1] = l
            },
            processData: function(a) {
                ...
                for (m = 0; m < c; m++) n = b[m],
                e = d && d[m] ? d[m] : {},
                "sum" === n || e.isSum ? b[m] = r(k) : "intermediateSum" === n || e.isIntermediateSum ? b[m] = r(l) : (k += n, l += n),
                p = Math.min(k, p),
                g = Math.max(k, g);
        ...
        },
        {
            ...
            getRadii: function(a, b, d, c) {
                ...
                u = b - a;
                k = 0;
                for (g = h.length; k < g; k++) f = h[k],
                l.sizeByAbsoluteValue && null !== f && (f = Math.abs(f - p), b = Math.max(b - p, Math.abs(a - p)), a = 0),
                null === f ? f = null: f < a ? f = d / 2 - 1 : (f = 0 < u ? (f - a) / u: .5, n && 0 <= f && (f = Math.sqrt(f)), f = Math.ceil(d + f * (c - d)) / 2),
                e.push(f);
                this.radii = e
            },
            animate: function(a) {
            ...
            translate: function() {
                ...
                for (a = b.length; a--;) d = b[a],
                c = f ? f[a] : 0,
                e(c) && c >= this.minPxSize / 2 ? (d.shapeType = "circle", d.shapeArgs = {
                    x: d.plotX,
                    y: d.plotY,
                    r: c
                },
            ...
            drawLegendSymbol: function(a, b) {
                ...
                b.legendSymbol = d.circle(c, a.baseline - c, c).attr({
                    zIndex: 3
                }).add(b.legendGroup);
        ...
        w.prototype.beforePadding = function() {
            ...
            q(this.series,
            function(b) {
                var g = b.options; ! b.bubblePadding || !b.visible && c.options.chart.ignoreHiddenSeries || (a.allowZoomOutside = !0, F.push(b), u && (q(["minSize", "maxSize"],
                function(a) {
                    var b = g[a],
                    d = /%$/.test(b),
                    b = f(b);
                    x[a] = d ? A * b / 100 : b
                }), b.minPxSize = x.minSize, b.maxPxSize = Math.max(x.maxSize, x.minSize), b = b.zData, b.length && (C = d(g.zMin, Math.min(C, Math.max(t(b), !1 === g.displayNegative ? g.zThreshold: -Number.MAX_VALUE))), D = d(g.zMax, Math.max(D, r(b))))))
            });
            q(F,
            function(b) {
                var d = b[m],
                ...
                if (0 < E) for (; c--;) e(d[c]) && a.dataMin <= d[c] && d[c] <= a.dataMax && (f = b.radii[c], h = Math.min((d[c] - w) * z - f, h), l = Math.max((d[c] - w) * z + f, l))
            });
            F.length && 0 < E && !this.isLog && (l -= b, z *= (b + h - l) / b, q([["min", "userMin", h], ["max", "userMax", l]],
            function(b) {
        ...
        function r(a, b) {
            ...
            k = d.plotLeft,
            p = d.plotTop;
            d.polar ? d.renderer.isSVG && (!0 === h && (h = {}), b ? (a = {
                translateX: l[0] + k,
                translateY: l[1] + p,
                scaleX: .001,
                scaleY: .001
            },
            e.attr(a), c && c.attr(a)) : (a = {
                translateX: k,
                translateY: p,
                scaleX: 1,
                scaleY: 1
            },
            e.animate(a, h), c && c.animate(a, h), this.animate = null)) : a.call(this, b)
        }
        var t = b.each,
        w = b.pick,
        m = b.seriesTypes,
        ...
        e.toXY = function(a) {
            ...
            this.kdByAngle ? (f = (h / Math.PI * 180 + this.xAxis.pane.options.startAngle) % 360, 0 > f && (f += 360), a.clientX = f) : a.clientX = a.plotX
        };
        m.spline && q(m.spline.prototype, "getPointSpline",
        function(a, b, f, h) {
            var d, c, e, k, p, g, n;
            this.chart.polar ? (d = f.plotX, c = f.plotY, a = b[h - 1], e = b[h + 1], this.connectEnds && (a || (a = b[b.length - 2]), e || (e = b[1])), a && e && (k = a.plotX, p = a.plotY, b = e.plotX, g = e.plotY, k = (1.5 * d + k) / 2.5, p = (1.5 * c + p) / 2.5, e = (1.5 * d + b) / 2.5, n = (1.5 * c + g) / 2.5, b = Math.sqrt(Math.pow(k - d, 2) + Math.pow(p - c, 2)), g = Math.sqrt(Math.pow(e - d, 2) + Math.pow(n - c, 2)), k = Math.atan2(p - c, k - d), p = Math.atan2(n - c, e - d), n = Math.PI / 2 + (k + p) / 2, Math.abs(k - n) > Math.PI / 2 && (n -= Math.PI), k = d + Math.cos(n) * b, p = c + Math.sin(n) * b, e = d + Math.cos(Math.PI + n) * g, n = c + Math.sin(Math.PI + n) * g, f.rightContX = e, f.rightContY = n), h ? (f = ["C", a.rightContX || a.plotX, a.rightContY || a.plotY, k || d, p || c, d, c], a.rightContX = a.rightContY = null) : f = ["M", d, c]) : f = a.call(this, b, f, h);
            return f
        });
        q(e, "translate",
        function(a) {
        ...
        function(a, b) {
            ...
            if (this.chart.polar) {
                ...
                for (e = 0; e < b.length; e++) if (!b[e].isNull) {
                    m = e;
                    break
                } ! 1 !== this.options.connectEnds && void 0 !== m && (this.connectEnds = !0, b.splice(b.length, 0, b[m]));
                t(b,
                function(a) {
        ...
        q(e, "animate", r);
        m.column && (m = m.column.prototype, m.polarArc = function(a, b, e, h) {
        ...
        function(a) {
            ...
            a.call(this);
            if (b.isRadial) for (h = this.points, c = h.length; c--;) m = h[c],
            a = m.barX + e,
            m.shapeType = "path",
            m.shapeArgs = {
        ...
        function(a, b, f, h, m, c) {
            this.chart.polar ? (a = b.rectPlotX / Math.PI * 180, null === h.align && (h.align = 20 < a && 160 > a ? "left": 200 < a && 340 > a ? "right": "center"), null === h.verticalAlign && (h.verticalAlign = 45 > a || 315 < a ? "bottom": 135 < a && 225 > a ? "top": "middle"), e.alignDataLabel.call(this, b, f, h, m, c)) : a.call(this, b, f, h, m, c)
        }));
        q(b, "getCoordinates",
        function(a, b) {
            var d = this.chart,
