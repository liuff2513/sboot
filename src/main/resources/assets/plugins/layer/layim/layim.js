...
xxim.view = (function(){
	...
	+'<div style=" width:296px;">'
        	+'<div style=" width:76px;display: inline-block;" class="xxim_tabs" id="xxim_tabs"><span class="xxim_tabfriend" title="好友"><i class="fa fa-user"></i></span><span class="xxim_tabgroup" title="群组"><i class="fa fa-users"></i></span><span class="xxim_latechat"  title="最近聊天"><i class="fa fa-clock-o"></i></span></div>'
            +'<div style=" width:auto;display: inline-block;" class="xxim_top" id="xxim_top">'
