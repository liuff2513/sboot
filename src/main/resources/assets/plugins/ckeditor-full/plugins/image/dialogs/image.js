...
(function() {
    var v = function(d, l) {
        ...
        A = function() {
            ...
            c && ("%" == c[2] && n(b, !1), a = c[1]);
            c = b.originalElement;
            var w = Math.round(300 / c.$.height * c.$.width);
            var h = Math.round(300 / c.$.width * c.$.height);

            console.log("高="+a);
            if(a>300){
                if("txtHeight" == this.id){//修改的是高，则改宽
            		a =h;
                }
                if("txtWidth" == this.id){
                    a =300;
            	...
            	if("txtHeight" == this.id){//修改的是高，则自动修改宽
            		//算出宽
            		w = Math.round(a / c.$.height * c.$.width);
            		if(w>300){//宽超过300,重新计算高
            			h = Math.round(300 / c.$.width * c.$.height);
            			a =h;
            			this.setValue(a);
                    }
            	}
                            ...
                            children: [{//宽度
                                ...
                                children: [{
                                    ...
                                    onChange: function() {
                                        var c = this.getValue();
                                        if(c>300){
                                           // var height = Math.round(300 / b.$.width * b.$.height);
                                            this.setValue(300);
                                        }
                                ...
                                {//高度
                                    ...
                                    onChange: function() {
                                        ...
                                        var a = this.getDialog(),
                                         c = a.originalElement;
                                        if(c.$.width>300&&h>300){
                                            var height = Math.round(300 / c.$.width * c.$.height);
