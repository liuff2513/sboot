...
import com.mine.sboot.core.mongodb.page.Pagination;
import com.mine.sboot.core.utils.reflect.Reflections;
...
public class BaseMongoRepositoryImpl<T, ID extends Serializable> extends SimpleMongoRepository<T, ID> implements BaseMongoRepository<T, ID>{
	...
	public BaseMongoRepositoryImpl(MongoEntityInformation<T, ID> metadata, MongoOperations mongoTemplate) {
