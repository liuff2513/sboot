...
import com.mine.sboot.core.jpa.enums.SearchFilter;
import com.mine.sboot.core.jpa.specs.DynamicSpecifications;
...
@Component
@Transactional
public abstract class BaseJpaService<T, ID extends Serializable> {
...
//	protected RedisCommands redisCommands;
	 ...
	 * @throws
	 * @author feifei.liu
	 * @date 2015年12月11日 上午11:29:09
	 */
	public Object saveObject(Object entity){
		return jpaRepository.saveObject(entity);
	}
