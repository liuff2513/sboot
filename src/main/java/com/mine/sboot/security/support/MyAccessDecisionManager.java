 ...
 * Description: AccessdecisionManager在Spring security中是很重要
 * 在验证部分简略提过了，所有的Authentication实现需要保存在一个GrantedAuthority对象数组中
 * 这就是赋予给主体的权限。 GrantedAuthority对象通过AuthenticationManager保存到 Authentication对象里，
 ...
 * Created by feifei.liu on 2017/6/5 18:56
 **/
@Service
